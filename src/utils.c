...
void printResultados(char *nomeJogador, char jogadas[][10]){
	...
	Número total de disparos realizados;

	Número de disparos na água;

	Número de disparos em embarcações, por tipo de embarcação (na ordem
	...
	Número de embarcações afundadas, por tipo de embarcação (na ordem
	inversa apresentada na tabela de embarcações, ou seja, começando pelo
	Destruidor), e omitindo os tipos para os quais não foi afundada qualquer
	embarcação.
	*/
	int totalDisparos = 0, totalEmbarcacoes = 0;
